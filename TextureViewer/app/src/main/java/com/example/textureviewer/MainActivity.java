...
public class MainActivity extends AppCompatActivity {
    ...
    private TextureView mTextureView; //be using to "draw" the preview of the Camera
    private String mCameraId; //represent one physical device's camera
    ...
    private ImageReader mImageReader; //that handles still image capture
    private CaptureRequest.Builder mPreviewRequestBuilder; // for the camera preview
    ...
    private void startBacgroundThread(){
        mBackgroundThread = new HandlerThread("CameraBackground");
        mBackgroundThread.start();
        mBackgroundHandler = new Handler(mBackgroundThread.getLooper());
    }
    private void stopBavkgroundThread() {
